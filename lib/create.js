...
module.exports = {
  ...
  new: function(directory, option) {
    if (option.traditional) {
      ...
      console.error('Current version of Noci doesn\'t support non-traditional problems.')
